...
@property (weak, nonatomic) IBOutlet UILabel *scPctFiltered;

@property (weak, nonatomic) IBOutlet UILabel *scAvailable;
@property (weak, nonatomic) IBOutlet UILabel *scPctAvailable;

@property (weak, nonatomic) IBOutlet UILabel *scDelivered;
@property (weak, nonatomic) IBOutlet UILabel *scPctDelivered2;

@property (weak, nonatomic) IBOutlet UILabel *scNotDelivered;
@property (weak, nonatomic) IBOutlet UILabel *scPctNotDelivered;

@property (weak, nonatomic) IBOutlet UILabel *scNotAttempted;
@property (weak, nonatomic) IBOutlet UILabel *scPctNotAttempted;
