...
// Sub-campaign statuses

#define kscStatusLoading                    @"Loading"
#define kscStatusRunning                    @"Running"
#define kscStatusPaused                     @"Paused"
#define kscStatusPending                    @"Pending"
#define kscStatusStopping                   @"Done"
...
// changeSubCampaignState: sc internal id, state
#define kchangeSubCampaignState             @"<ns:changeSubCampaignState><arg1><subCampaign><internalId>%@</internalId></subCampaign><state>%@</state></arg1></ns:changeSubCampaignState>"
